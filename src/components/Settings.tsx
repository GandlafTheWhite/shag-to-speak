      ...
      <header className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 max-w-full">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl sm:text-2xl font-display font-bold ml-2">Настройки</h1>
          </div>
        </div>
      </header>

      <main className="container mx-auto px-3 sm:px-4 py-6 sm:py-8 max-w-3xl animate-fade-in">
        <Card className="mb-6">
          <CardHeader>
